...
class CartScreen extends StatefulWidget {
  ...
  final int sellerId;
  const CartScreen({Key? key, this.fromCheckout = false, this.sellerId = 1})
      : super(key: key);
                        ...
                        children: [
                            ...
                            Builder(
                              builder: (context) => InkWell(
                                onTap: () {
                                  for (ShippingModel shipping
                                      in Provider.of<CartProvider>(context,
                                              listen: false)
                                          .shippingList!) {}
                                                              ...
                                                              child: Padding(
                                                                ...
                                                                child: Row(
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      Flexible(
                                                                          child: Text(
                                                                              (cart.shippingList == null || cart.shippingList![index].shippingMethodList == null || cart.chosenShippingList.isEmpty || cart.shippingList![index].shippingIndex == -1) ? '' : cart.shippingList![index].shippingMethodList![cart.shippingList![index].shippingIndex!].title.toString(),
